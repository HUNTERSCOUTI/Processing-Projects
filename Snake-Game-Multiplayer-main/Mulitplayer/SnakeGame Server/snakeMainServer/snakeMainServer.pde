...
void setup(){
  ...
  ws= new WebsocketServer(this,8025,"/hello");
...
void webSocketServerEvent(String msg){
   ...
   sx2 = snake.getFloat("x2");
   sy2 = snake.getFloat("y2");
   poi2 = new PVector (snake.getFloat("pointx2"), snake.getFloat("pointy2"));
...
void draw() {
  ...
  snake.setFloat("x1", head.x.get(0));
  snake.setFloat("y1", head.y.get(0));
  snake.setInt("size", head.x.size());
  snake.setFloat("pointx1", point.pointx);
  snake.setFloat("pointy1", point.pointy);
  ws.sendMessage(snake.toString());
